...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Chess_MiSTer.git"
CORE_NAME=(Chess)
...
UPSTREAM_CORE_NAME=(Chess)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Chess.qpf)
COMPILATION_OUTPUT=(output_files/Chess.rbf)
